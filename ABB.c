...
#include <stdio.h>
#include <stdlib.h>
/*se incluye string.h para reconocer la funcion strcmp()*/
#include <string.h>
...
int _comparar_claves(TIPOCLAVE cl1, TIPOCLAVE cl2) {
    /*en caso de que la funcion strcmp nos devuelva un 0, querra decir que ambas cadenas son
     iguales por lo que devuelve un 0, si strcmp nos devuelve un numero positivo querra decir
     que la primera cadena es mayor que la segunda y devuelve un 1. De no ser asi la primera
     cadena sera menor que la segunda por lo que devuelve un -1*/
